          ...
          {(() => {
            ...
            return <>
              ...
              {(page === "GetMGP" || page === "GetSTMGP" || page === "GetBMGP" || page === "FixedYield" || page === "GetYMGP" || page === "GetSYMGP" || page === "SupplyLiquidity" || page === "GetVMGP" || page === "GetWSTMGP" || page === "vote") && <Card>
                ...
                {page === "GetSYMGP" && <GetSYMGP mgpAPR={rewards.vlMGP.APR} nativeSwap={actions.nativeSwap} rmgpBalance={balances.user.rMGP} send={amounts.send} setSend={amountsActions.setSend} stmgpSupply={supplies.stMGP} symgpBalance={balances.user.syMGP} symgpSupply={supplies.syMGP} ymgpBalance={balances.user.yMGP} ymgpLocked={balances.syMGP.yMGP} />}
              ...
              <PegCards bonds={bonds} exchangeRates={exchangeRates} rewards={rewards} supplies={supplies} />
              <QASection />
              <ContractsCard />
            </>;
          })()}
