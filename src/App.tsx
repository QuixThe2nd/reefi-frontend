          ...
          {(() => {
            ...
            if (page === "claim") return <div className="flex flex-col h-screen bg-gray-900 text-white">
              ...
              <div className="grid grid-cols-1 gap-6 mt-6 lg:grid-cols-2">
                <Card>
                  ...
                  <ClaimYield claimYMGPRewards={() => claimYMGPRewards()} lockedYMGP={supplies.lyMGP} unclaimedUserYield={rewards.unclaimedUserYield} uncompoundedMGPYield={rewards.uncompoundedMGPYield} userLockedYMGP={balances.user.lyMGP} ymgpHoldings={balances.user.ymgpHoldings} ymgpSupply={supplies.yMGP} />
                </Card>
                <Card>
            ...
            return <>
              ...
              <Card>
                ...
                {page === "getMGP" && <GetMGPPage mgpAPR={rewards.vlmgpAPR} balances={balances.user} setSend={amountsActions.setSend} send={amounts.send} prices={prices} ymgpMgpCurveRate={exchangeRates.ymgpMGP} mgpRmgpCurveRate={exchangeRates.mgpRMGP} mgpRmgpCurveAmount={amounts.curve.MGP.rMGP} rmgpYmgpCurveAmount={amounts.curve.rMGP.yMGP} rmgpMgpCurveAmount={amounts.curve.rMGP.MGP} mgpYmgpCurveAmount={amounts.curve.MGP.yMGP} ymgpRmgpCurveAmount={amounts.curve.yMGP.rMGP} ymgpMgpCurveAmount={amounts.curve.yMGP.MGP} allowances={allowances} chain={chain} buyMGP={buyMGP} approve={approve} convertMGP={convertMGP} sellYMGP={sellYMGP} mintWETH={mintWETH} swap={swap} lockedReefiMGP={balances.rMGP.MGP} rmgpSupply={supplies.rMGP} ymgpVmgpCurveAmount={amounts.curve.yMGP.vMGP} />}
                {page === "deposit" && <GetRMGPPage mgpAPR={rewards.vlmgpAPR} depositMGP={depositMGP} balances={balances.user} setSend={amountsActions.setSend} send={amounts.send} prices={prices} ymgpMgpCurveRate={exchangeRates.ymgpMGP} mgpRmgpCurveRate={exchangeRates.mgpRMGP} mgpRmgpCurveAmount={amounts.curve.MGP.rMGP} rmgpYmgpCurveAmount={amounts.curve.rMGP.yMGP} rmgpMgpCurveAmount={amounts.curve.rMGP.MGP} mgpYmgpCurveAmount={amounts.curve.MGP.yMGP} ymgpRmgpCurveAmount={amounts.curve.yMGP.rMGP} ymgpMgpCurveAmount={amounts.curve.yMGP.MGP} allowances={allowances} chain={chain} buyRMGP={buyRMGP} approve={approve} convertMGP={convertMGP} sellYMGP={sellYMGP} mintWETH={mintWETH} swap={swap} lockedReefiMGP={balances.rMGP.MGP} rmgpSupply={supplies.rMGP} ymgpVmgpCurveAmount={amounts.curve.yMGP.vMGP} />}
                {page === "redeem" && <RedeemRMGPPage buyMGP={() => buyMGP()} redeemRMGP={redeemRMGP} withdrawMGP={withdrawMGP} unlockSchedule={withdraws.unlockSchedule} balances={balances.user} setSend={amountsActions.setSend} send={amounts.send} prices={prices} ymgpMgpCurveRate={exchangeRates.ymgpMGP} mgpRmgpCurveRate={exchangeRates.mgpRMGP} mgpRmgpCurveAmount={amounts.curve.MGP.rMGP} rmgpYmgpCurveAmount={amounts.curve.rMGP.yMGP} rmgpMgpCurveAmount={amounts.curve.rMGP.MGP} mgpYmgpCurveAmount={amounts.curve.MGP.yMGP} ymgpRmgpCurveAmount={amounts.curve.yMGP.rMGP} ymgpMgpCurveAmount={amounts.curve.yMGP.MGP} allowances={allowances} userPendingWithdraws={withdraws.userPending} userWithdrawable={withdraws.userWithdrawable} chain={chain} approve={approve} convertMGP={convertMGP} sellYMGP={sellYMGP} mintWETH={mintWETH} swap={swap} lockedReefiMGP={balances.rMGP.MGP} rmgpSupply={supplies.rMGP} ymgpVmgpCurveAmount={amounts.curve.yMGP.vMGP} />}
                {page === "fixedYield" && <FixedYieldPage mgpAPR={rewards.vlmgpAPR} balances={balances.user} setSend={amountsActions.setSend} send={amounts.send} prices={prices} ymgpMgpCurveRate={exchangeRates.ymgpMGP} mgpRmgpCurveRate={exchangeRates.mgpRMGP} mgpRmgpCurveAmount={amounts.curve.MGP.rMGP} rmgpYmgpCurveAmount={amounts.curve.rMGP.yMGP} rmgpMgpCurveAmount={amounts.curve.rMGP.MGP} mgpYmgpCurveAmount={amounts.curve.MGP.yMGP} ymgpRmgpCurveAmount={amounts.curve.yMGP.rMGP} ymgpMgpCurveAmount={amounts.curve.yMGP.MGP} allowances={allowances} chain={chain} lockedReefiMGP={balances.rMGP.MGP} rmgpSupply={supplies.rMGP} unlockSchedule={withdraws.unlockSchedule} approve={approve} convertMGP={convertMGP} sellYMGP={sellYMGP} mintWETH={mintWETH} swap={swap} buyRMGPAndWithdraw={buyRMGPAndWithdraw} ymgpVmgpCurveAmount={amounts.curve.yMGP.vMGP} />}
                ...
                {page === "redeemYMGP" && <RedeemYMGPPage buyRMGP={() => buyRMGP()} redeemYMGP={() => redeemYMGP()} withdrawMGP={() => withdrawMGP()} unlockSchedule={withdraws.unlockSchedule} balances={balances.user} setSend={amountsActions.setSend} send={amounts.send} prices={prices} ymgpMgpCurveRate={exchangeRates.ymgpMGP} mgpRmgpCurveRate={exchangeRates.mgpRMGP} mgpRmgpCurveAmount={amounts.curve.MGP.rMGP} rmgpYmgpCurveAmount={amounts.curve.rMGP.yMGP} rmgpMgpCurveAmount={amounts.curve.rMGP.MGP} mgpYmgpCurveAmount={amounts.curve.MGP.yMGP} ymgpRmgpCurveAmount={amounts.curve.yMGP.rMGP} ymgpMgpCurveAmount={amounts.curve.yMGP.MGP} allowances={allowances} userPendingWithdraws={withdraws.userPending} userWithdrawable={withdraws.userWithdrawable} chain={chain} approve={approve} convertMGP={convertMGP} sellYMGP={sellYMGP} mintWETH={mintWETH} swap={swap} lockedReefiMGP={balances.rMGP.MGP} rmgpSupply={supplies.rMGP} ymgpVmgpCurveAmount={amounts.curve.yMGP.vMGP} />}
                <div className="bg-gray-500 w-full h-[0.5px] mt-8" />
                <div className="flex flex-col-reverse justify-between gap-2 lg:flex-row mt-8 w-full">
                  <div className="flex rounded-lg bg-gray-700 p-1">
