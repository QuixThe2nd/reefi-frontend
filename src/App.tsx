          ...
          {(() => {
            ...
            return <>
              ...
              <Card>
                ...
                {page === "getMGP" && <GetMGPPage mgpAPR={rewards.vlmgpAPR} balances={balances} setSend={amountsActions.setSend} send={amounts.send} allowances={allowances} chain={wallet.chain} approve={actions.approve} mintWETH={actions.mintWETH} swap={actions.swap} curveAmounts={amounts.curve} supplies={supplies} curveBuy={actions.curveBuy} nativeSwap={actions.nativeSwap} />}
                ...
                {page === "redeem" && <RedeemRMGPPage withdrawMGP={actions.withdrawMGP} unlockSchedule={withdraws.reefi.unlockSchedule} balances={balances} setSend={amountsActions.setSend} send={amounts.send} allowances={allowances} userPendingWithdraws={withdraws.userPending} userWithdrawable={withdraws.user.ready} chain={wallet.chain} approve={actions.approve} mintWETH={actions.mintWETH} swap={actions.swap} curveAmounts={amounts.curve} supplies={supplies} curveBuy={actions.curveBuy} nativeSwap={actions.nativeSwap} />}
