          ...
          {(() => {
            ...
            return <>
              ...
              {(page === "GetMGP" || page === "GetSTMGP" || page === "GetBMGP" || page === "FixedYield" || page === "GetYMGP" || page === "GetSYMGP" || page === "SupplyLiquidity" || page === "GetVMGP" || page === "GetWSTMGP" || page === "vote") && <Card>
                ...
                {page === "GetSYMGP" && <SwapPage approve={actions.approve} curveBuy={actions.curveBuy} info={[<span key="lock ymgp">yMGP and rMGP can be locked 1:1 to earn additional auto-compounded yield. 5% of protocol yield and 25% of yMGP withdrawals are paid to syMGP.</span>, <span key="locked ymgp governance">syMGP holders are able to vote on Reefi governance proposals.</span>]} mintWETH={actions.mintWETH} nativeSwap={actions.nativeSwap} odosBuy={actions.buyOnOdos} secondaryToken="rMGP" tokenOut="syMGP" tokensIn={["yMGP", "syMGP"]} />}
