  ...
  return <>
    ...
    <div className="flex h-screen bg-gray-900 text-white">
      ...
      <div className="grow overflow-auto">
        <Header ens={wallet.ens} chain={wallet.chain} page={page} setPage={setPage} account={wallet.account} isConnecting={wallet.isConnecting} setChain={walletActions.setChain} connectWallet={walletActions.connectWallet} mgpBalance={balances.user.MGP} rmgpBalance={balances.user.rMGP} ymgpBalance={balances.user.yMGP} cmgpBalance={balances.user.cMGP} />
        <div className="flex flex-col gap-6 p-4 md:mx-16 md:p-6 lg:mx-24 xl:mx-28">
          {(() => {
            ...
            if (page === "claim") return <div className="flex flex-col h-screen bg-gray-900 text-white">
              ...
              <ErrorCard error={error} setError={setError} />
              <Card>
                <CompoundYield uncompoundedMGPYield={rewards.reefi.vlMGP.estimatedMGP} estimatedCompoundGasFee={rewards.reefi.vlMGP.estimatedGas} pendingRewards={rewards.reefi.vlMGP.pendingRewards} estimatedCompoundAmount={rewards.reefi.vlMGP.estimatedMGP} mgpAPR={rewards.vlmgpAPR} reefiMGPLocked={balances.rMGP.MGP} prices={prices} compoundRMGP={() => compoundRMGP()} />
              </Card>
              <div className="grid grid-cols-1 gap-6 mt-6 lg:grid-cols-2">
                <Card>
                  <h2 className="mb-4 text-xl font-bold">Claim yMGP Rewards</h2>
                  <ClaimYield claimYMGPRewards={() => claimYMGPRewards()} lockedYMGP={supplies.lyMGP} unclaimedUserYield={rewards.user.lyMGP} uncompoundedMGPYield={rewards.reefi.vlMGP.estimatedMGP} userLockedYMGP={balances.user.lyMGP} ymgpHoldings={balances.yMGP.rMGP} ymgpSupply={supplies.yMGP} />
                </Card>
                <Card>
            ...
            if (page === "bridge") return <div className="flex flex-col h-screen bg-gray-900 text-white">
              ...
              <div className="grid grid-cols-1 gap-6 pb-6 mt-6 lg:grid-cols-2">
                <Card>
                  ...
                  <GetWRMGPPage depositMGP={() => depositMGP()} balances={balances.user} setSend={amountsActions.setSend} send={amounts.send} prices={prices} ymgpMgpCurveRate={exchangeRates.ymgpMGP} mgpRmgpCurveRate={exchangeRates.mgpRMGP} mgpRmgpCurveAmount={amounts.curve.MGP.rMGP} rmgpYmgpCurveAmount={amounts.curve.rMGP.yMGP} rmgpMgpCurveAmount={amounts.curve.rMGP.MGP} mgpYmgpCurveAmount={amounts.curve.MGP.yMGP} ymgpRmgpCurveAmount={amounts.curve.yMGP.rMGP} ymgpMgpCurveAmount={amounts.curve.yMGP.MGP} allowances={allowances} chain={wallet.chain} wrapRMGP={() => wrapRMGP()} approve={approve} convertMGP={convertMGP} sellYMGP={sellYMGP} mintWETH={mintWETH} swap={swap} lockedReefiMGP={balances.rMGP.MGP} rmgpSupply={supplies.rMGP} ymgpVmgpCurveAmount={amounts.curve.yMGP.vMGP} />
                </Card>
                <Card>
                  <h2 className="mb-4 text-xl font-bold">Unwrap wrMGP</h2>
                  <UnwrapWRMGPPage depositMGP={() => depositMGP()} balances={balances.user} setSend={amountsActions.setSend} send={amounts.send} prices={prices} ymgpMgpCurveRate={exchangeRates.ymgpMGP} mgpRmgpCurveRate={exchangeRates.mgpRMGP} mgpRmgpCurveAmount={amounts.curve.MGP.rMGP} rmgpYmgpCurveAmount={amounts.curve.rMGP.yMGP} rmgpMgpCurveAmount={amounts.curve.rMGP.MGP} mgpYmgpCurveAmount={amounts.curve.MGP.yMGP} ymgpRmgpCurveAmount={amounts.curve.yMGP.rMGP} ymgpMgpCurveAmount={amounts.curve.yMGP.MGP} allowances={allowances} chain={wallet.chain} unwrapWRMGP={() => unwrapWRMGP()} approve={approve} convertMGP={convertMGP} sellYMGP={sellYMGP} mintWETH={mintWETH} swap={swap} lockedReefiMGP={balances.rMGP.MGP} rmgpSupply={supplies.rMGP} ymgpVmgpCurveAmount={amounts.curve.yMGP.vMGP} />
                </Card>
              </div>
            </div>;
            ...
            return <>
              ...
              <Card>
                ...
                {page === "getMGP" && <GetMGPPage mgpAPR={rewards.vlmgpAPR} balances={balances.user} setSend={amountsActions.setSend} send={amounts.send} prices={prices} ymgpMgpCurveRate={exchangeRates.ymgpMGP} mgpRmgpCurveRate={exchangeRates.mgpRMGP} mgpRmgpCurveAmount={amounts.curve.MGP.rMGP} rmgpYmgpCurveAmount={amounts.curve.rMGP.yMGP} rmgpMgpCurveAmount={amounts.curve.rMGP.MGP} mgpYmgpCurveAmount={amounts.curve.MGP.yMGP} ymgpRmgpCurveAmount={amounts.curve.yMGP.rMGP} ymgpMgpCurveAmount={amounts.curve.yMGP.MGP} allowances={allowances} chain={wallet.chain} buyMGP={() => buyMGP()} approve={() => approve()} convertMGP={() => convertMGP()} sellYMGP={() => sellYMGP()} mintWETH={() => mintWETH()} swap={() => swap()} lockedReefiMGP={balances.rMGP.MGP} rmgpSupply={supplies.rMGP} ymgpVmgpCurveAmount={amounts.curve.yMGP.vMGP} />}
                {page === "deposit" && <GetRMGPPage mgpAPR={rewards.vlmgpAPR} depositMGP={depositMGP} balances={balances.user} setSend={amountsActions.setSend} send={amounts.send} prices={prices} ymgpMgpCurveRate={exchangeRates.ymgpMGP} mgpRmgpCurveRate={exchangeRates.mgpRMGP} mgpRmgpCurveAmount={amounts.curve.MGP.rMGP} rmgpYmgpCurveAmount={amounts.curve.rMGP.yMGP} rmgpMgpCurveAmount={amounts.curve.rMGP.MGP} mgpYmgpCurveAmount={amounts.curve.MGP.yMGP} ymgpRmgpCurveAmount={amounts.curve.yMGP.rMGP} ymgpMgpCurveAmount={amounts.curve.yMGP.MGP} allowances={allowances} chain={wallet.chain} buyRMGP={() => buyRMGP()} approve={() => approve()} convertMGP={() => convertMGP()} sellYMGP={() => sellYMGP()} mintWETH={() => mintWETH()} swap={() => swap()} lockedReefiMGP={balances.rMGP.MGP} rmgpSupply={supplies.rMGP} ymgpVmgpCurveAmount={amounts.curve.yMGP.vMGP} />}
                {page === "redeem" && <RedeemRMGPPage buyMGP={() => buyMGP()} redeemRMGP={() => redeemRMGP()} withdrawMGP={() => withdrawMGP()} unlockSchedule={withdraws.reefi.unlockSchedule} balances={balances.user} setSend={amountsActions.setSend} send={amounts.send} prices={prices} ymgpMgpCurveRate={exchangeRates.ymgpMGP} mgpRmgpCurveRate={exchangeRates.mgpRMGP} mgpRmgpCurveAmount={amounts.curve.MGP.rMGP} rmgpYmgpCurveAmount={amounts.curve.rMGP.yMGP} rmgpMgpCurveAmount={amounts.curve.rMGP.MGP} mgpYmgpCurveAmount={amounts.curve.MGP.yMGP} ymgpRmgpCurveAmount={amounts.curve.yMGP.rMGP} ymgpMgpCurveAmount={amounts.curve.yMGP.MGP} allowances={allowances} userPendingWithdraws={withdraws.userPending} userWithdrawable={withdraws.user.ready} chain={wallet.chain} approve={() => approve()} convertMGP={() => convertMGP()} sellYMGP={() => sellYMGP()} mintWETH={() => mintWETH()} swap={() => swap()} lockedReefiMGP={balances.rMGP.MGP} rmgpSupply={supplies.rMGP} ymgpVmgpCurveAmount={amounts.curve.yMGP.vMGP} />}
                {page === "fixedYield" && <FixedYieldPage mgpAPR={rewards.vlmgpAPR} balances={balances.user} setSend={amountsActions.setSend} send={amounts.send} prices={prices} ymgpMgpCurveRate={exchangeRates.ymgpMGP} mgpRmgpCurveRate={exchangeRates.mgpRMGP} mgpRmgpCurveAmount={amounts.curve.MGP.rMGP} rmgpYmgpCurveAmount={amounts.curve.rMGP.yMGP} rmgpMgpCurveAmount={amounts.curve.rMGP.MGP} mgpYmgpCurveAmount={amounts.curve.MGP.yMGP} ymgpRmgpCurveAmount={amounts.curve.yMGP.rMGP} ymgpMgpCurveAmount={amounts.curve.yMGP.MGP} allowances={allowances} chain={wallet.chain} lockedReefiMGP={balances.rMGP.MGP} rmgpSupply={supplies.rMGP} unlockSchedule={withdraws.reefi.unlockSchedule} approve={() => approve()} convertMGP={() => convertMGP()} sellYMGP={() => sellYMGP()} mintWETH={() => mintWETH()} swap={() => swap()} buyRMGPAndWithdraw={() => buyRMGPAndWithdraw()} ymgpVmgpCurveAmount={amounts.curve.yMGP.vMGP} />}
                ...
                {page === "convert" && <GetYMGPPage balances={balances.user} setSend={amountsActions.setSend} send={amounts.send} prices={prices} ymgpMgpCurveRate={exchangeRates.ymgpMGP} mgpRmgpCurveRate={exchangeRates.mgpRMGP} mgpRmgpCurveAmount={amounts.curve.MGP.rMGP} rmgpYmgpCurveAmount={amounts.curve.rMGP.yMGP} rmgpMgpCurveAmount={amounts.curve.rMGP.MGP} mgpYmgpCurveAmount={amounts.curve.MGP.yMGP} ymgpRmgpCurveAmount={amounts.curve.yMGP.rMGP} ymgpMgpCurveAmount={amounts.curve.yMGP.MGP} allowances={allowances} chain={wallet.chain} approve={() => approve()} convertMGP={() => convertMGP()} sellYMGP={() => sellYMGP()} mintWETH={() => mintWETH()} swap={() => swap()} buyYMGP={() => buyYMGP()} depositRMGP={() => depositRMGP()} lockedReefiMGP={balances.rMGP.MGP} rmgpSupply={supplies.rMGP} ymgpVmgpCurveAmount={amounts.curve.yMGP.vMGP} />}
                {page === "lock" && <LockPage ymgpBalance={balances.user.yMGP} setSend={amountsActions.setSend} send={amounts.send} lockYMGP={() => lockYMGP()} mgpAPR={rewards.vlmgpAPR} reefiLockedMGP={balances.rMGP.MGP} ymgpLocked={supplies.lyMGP} />}
                {page === "unlock" && <UnlockPage send={amounts.send} setSendAmount={amountsActions.setSend} unlockYMGP={() => unlockYMGP()} lymgpBalance={balances.user.lyMGP} />}
                {page === "redeemYMGP" && <RedeemYMGPPage buyRMGP={() => buyRMGP()} redeemYMGP={() => redeemYMGP()} withdrawMGP={() => withdrawMGP()} unlockSchedule={withdraws.reefi.unlockSchedule} balances={balances.user} setSend={amountsActions.setSend} send={amounts.send} prices={prices} ymgpMgpCurveRate={exchangeRates.ymgpMGP} mgpRmgpCurveRate={exchangeRates.mgpRMGP} mgpRmgpCurveAmount={amounts.curve.MGP.rMGP} rmgpYmgpCurveAmount={amounts.curve.rMGP.yMGP} rmgpMgpCurveAmount={amounts.curve.rMGP.MGP} mgpYmgpCurveAmount={amounts.curve.MGP.yMGP} ymgpRmgpCurveAmount={amounts.curve.yMGP.rMGP} ymgpMgpCurveAmount={amounts.curve.yMGP.MGP} allowances={allowances} userPendingWithdraws={withdraws.user.pending} userWithdrawable={withdraws.user.ready} chain={wallet.chain} approve={() => approve()} convertMGP={() => convertMGP()} sellYMGP={() => sellYMGP()} mintWETH={() => mintWETH()} swap={() => swap()} lockedReefiMGP={balances.rMGP.MGP} rmgpSupply={supplies.rMGP} ymgpVmgpCurveAmount={amounts.curve.yMGP.vMGP} />}
                <div className="bg-gray-500 w-full h-[0.5px] mt-8" />
                <div className="flex flex-col-reverse justify-between gap-2 lg:flex-row mt-8 w-full">
                  <div className="flex rounded-lg bg-gray-700 p-1">
                ...
                {page === "getVMGP" && <GetVMGPPage balances={balances.user} setSend={amountsActions.setSend} send={amounts.send} prices={prices} ymgpMgpCurveRate={exchangeRates.ymgpMGP} mgpRmgpCurveRate={exchangeRates.mgpRMGP} mgpRmgpCurveAmount={amounts.curve.MGP.rMGP} rmgpYmgpCurveAmount={amounts.curve.rMGP.yMGP} rmgpMgpCurveAmount={amounts.curve.rMGP.MGP} mgpYmgpCurveAmount={amounts.curve.MGP.yMGP} ymgpRmgpCurveAmount={amounts.curve.yMGP.rMGP} ymgpMgpCurveAmount={amounts.curve.yMGP.MGP} allowances={allowances} chain={wallet.chain} approve={() => approve()} convertMGP={() => convertMGP()} sellYMGP={() => sellYMGP()} mintWETH={() => mintWETH()} swap={() => swap()} buyVMGP={() => buyVMGP()} mintVMGP={() => mintVMGP()} lockedReefiMGP={balances.rMGP.MGP} rmgpSupply={supplies.rMGP} ymgpVmgpCurveAmount={amounts.curve.yMGP.vMGP} />}
                {page === "lockVMGP" && <LockVMGPPage vmgpBalance={balances.user.vMGP} setSend={amountsActions.setSend} send={amounts.send} lockYMGP={() => lockVMGP()} mgpAPR={rewards.vlmgpAPR} />}
                {page === "unlockVMGP" && <UnlockVMGPPage send={amounts.send} setSendAmount={amountsActions.setSend} unlockVMGP={() => unlockVMGP()} lvmgpBalance={balances.user.lvMGP} />}
                <div className="bg-gray-500 w-full h-[0.5px] mt-8" />
                <div className="flex flex-col-reverse justify-between gap-2 lg:flex-row mt-8 w-full">
                  <div className="flex rounded-lg bg-gray-700 p-1">
