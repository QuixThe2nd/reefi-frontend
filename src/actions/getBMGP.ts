...
export const getBMGP = ({ send, chain, address, setError, contracts }: Properties) => (writeContract: UseWriteContractReturnType<typeof wagmiConfig>["writeContract"], unlock: boolean) => {
