...
export const ConnectWallet = memo(({ connectRequired, connectWallet, isConnecting }: { readonly connectRequired: boolean, readonly connectWallet: () => void, readonly isConnecting: boolean }): ReactElement => {
