...
export const ConnectWallet = memo(({ connectRequired, isConnecting, connectWallet }: Readonly<{ connectRequired: boolean; isConnecting: boolean; connectWallet: () => void }>): ReactElement | undefined => connectRequired ? <div className="absolute z-10 flex size-full items-center justify-center bg-black">
