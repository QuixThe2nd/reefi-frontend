...
export const ConversionRates = memo(({ mgpRMGP, rmgpMGP, rmgpYMGP, ymgpRMGP, mintRMGP }: Props): ReactElement => {
      ...
      <table>
        ...
        <tbody>
          <tr>
            ...
            <td><p className="mx-4 my-1 text-sm">{formatNumber(mintRMGP, 4)} MGP</p></td>
            <td><p className="mx-4 my-1 text-sm">{formatNumber(mgpRMGP, 4)} MGP</p></td>
            <td><p className="mx-4 my-1 text-sm">{formatNumber(rmgpMGP, 4)} MGP</p></td>
            <td><p className="mx-4 my-1 text-sm">{formatNumber(mintRMGP*0.9, 4)} MGP</p></td>
          </tr>
          <tr>
            <td><p className="mx-4 my-1 text-sm font-bold">yMGP</p></td>
            <td><p className="mx-4 my-1 text-sm">1 rMGP</p></td>
            <td><p className="mx-4 my-1 text-sm">{formatNumber(rmgpYMGP, 4)} rMGP</p></td>
            <td><p className="mx-4 my-1 text-sm">{formatNumber(ymgpRMGP, 4)} rMGP</p></td>
