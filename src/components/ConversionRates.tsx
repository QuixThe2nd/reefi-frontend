...
export const ConversionRates = memo(({ mgpRMGPCurveRate, rmgpMGPCurveRate, rmgpYMGPCurveRate, ymgpRMGPCurveRate, reefiMGPLocked, rmgpSupply }: { mgpRMGPCurveRate: number; rmgpMGPCurveRate: number; rmgpYMGPCurveRate: number; ymgpRMGPCurveRate: number; reefiMGPLocked: bigint; rmgpSupply: bigint }): ReactElement => <div className="flex flex-col items-center rounded-xl border border-gray-700 bg-gray-800 p-3">
  <div className="flex w-full max-w-4xl flex-col items-center">
    ...
    <div className="rounded-lg bg-gray-700/50 p-1 sm:p-4">
      <table>
        <thead>
          <tr>
            <th><h3 className="mx-1 mb-2 text-lg font-bold" /></th>
            <th><h3 className="mx-1 mb-2 text-lg font-bold">Mint</h3></th>
            <th><h3 className="mx-1 mb-2 text-lg font-bold">Market Buy</h3></th>
            <th><h3 className="mx-1 mb-2 text-lg font-bold">Spread</h3></th>
            <th><h3 className="mx-1 mb-2 text-lg font-bold">Market Sell</h3></th>
            <th><h3 className="mx-1 mb-2 text-lg font-bold">Burn</h3></th>
          </tr>
        </thead>
        <tbody>
          <tr>
            <td><p className="mx-2 my-1 text-sm font-bold sm:mx-4">1 rMGP</p></td>
            <td><p className="mx-2 my-1 text-sm sm:mx-4">{formatNumber(Number(reefiMGPLocked) / Number(rmgpSupply), 4)} MGP</p></td>
            <td><p className="mx-2 my-1 text-sm sm:mx-4">{formatNumber(1 / mgpRMGPCurveRate, 4)} MGP</p></td>
            <td><p className="mx-2 my-1 text-sm sm:mx-4">{formatNumber(100 / mgpRMGPCurveRate / rmgpMGPCurveRate - 100)}%</p></td>
            <td><p className="mx-2 my-1 text-sm sm:mx-4">{formatNumber(rmgpMGPCurveRate, 4)} MGP</p></td>
            <td><p className="mx-2 my-1 text-sm sm:mx-4">{formatNumber(Number(reefiMGPLocked) / Number(rmgpSupply) * 0.9, 4)} MGP</p></td>
          </tr>
          <tr>
            <td><p className="mx-2 my-1 text-sm font-bold sm:mx-4">1 yMGP</p></td>
            <td><p className="mx-2 my-1 text-sm sm:mx-4">1 rMGP</p></td>
            <td><p className="mx-2 my-1 text-sm sm:mx-4">{formatNumber(1 / rmgpYMGPCurveRate, 4)} rMGP</p></td>
            <td><p className="mx-2 my-1 text-sm sm:mx-4">{formatNumber(100 / rmgpYMGPCurveRate / ymgpRMGPCurveRate - 100)}%</p></td>
            <td><p className="mx-2 my-1 text-sm sm:mx-4">{formatNumber(ymgpRMGPCurveRate, 4)} rMGP</p></td>
