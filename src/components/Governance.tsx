...
export const Governance = (): ReactElement => {
  return <div className="bg-gray-800 p-4 rounded-xl border border-gray-700 mb-6">
    ...
    <p className="text-gray-400 text-xs mt-2">Locked yMGP controls the entirety of Reefi&apos;s vlMGP voting power on Magpie votes. yMGP votes are cast to Reefi&apos;s DAO. Once Reefi voting is complete, the vote will be forwarded to Magpie.</p>
