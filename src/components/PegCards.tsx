...
export const PegCards = ({ bonds, rewards, balances, exchangeRates, supplies }: Properties) => {
  const stmgpTarget = () => {
  ...
  return <div className="grid grid-cols-2 gap-6">
    ...
    <div className="flex flex-col gap-6">
      ...
      <PegCard rates={[{ label: "1 yMGP", value: 1, color: "emerald" }, { label: "1 syMGP", value: Number(balances.syMGP.yMGP) / Number(supplies.syMGP), color: "green", required: true }]} spread={0} targetToken="yMGP" token="syMGP" />
    </div>
  </div>;
};
