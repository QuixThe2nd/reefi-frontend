...
export const TokenCards = memo(({ mgpPrice, supplies, mgpStmgpCurveRate, wstmgpYmgpCurveRate, ymgpVmgpCurveRate, stmgpRmgpCurveRate }: Properties): ReactElement => <div className="grid grid-cols-2 gap-4 md:grid-cols-5">
  ...
  <TokenCard description="yMGP is backed 1:1 by wstMGP but has a 25% withdraw fee. 5% of vlMGP yield is distributed to locked yMGP paid in wstMGP." locked={supplies.syMGP / 2n} marketRate={wstmgpYmgpCurveRate} supply={supplies.yMGP} symbol="yMGP" underlying={supplies.yMGP} underlyingSymbol="wstMGP" />
  ...
  <TokenCard description="rMGP is a Syntheic MGP, not backed by any underlying MGP. rMGP is a Pendle-like token with no maturity allowing for trading on yield." locked={supplies.syMGP / 2n} marketRate={stmgpRmgpCurveRate} supply={supplies.rMGP} underlying={supplies.rMGP} symbol="rMGP" />
</div>);
