...
export const TokenCards = ({ mgpPrice, supplies, mgpStmgpCurveRate, wstmgpYmgpCurveRate, ymgpVmgpCurveRate, stmgpRmgpCurveRate }: Properties): ReactElement => <div className="grid grid-cols-2 gap-4 md:grid-cols-5">
  ...
  <TokenCard description="stMGP earns auto compounding yield from locked MGP, while remaining liquid. stMGP is rebasing and can be converted to MGP 1:1." marketRate={mgpStmgpCurveRate} supply={supplies.stMGP} symbol="stMGP" underlying={supplies.stMGP} underlyingSymbol="MGP" />
  <TokenCard description="yMGP is backed 1:1 by wstMGP with a 25% withdraw fee. yMGP is critical for maintaining the peg of most derivatives." locked={supplies.syMGP / 2n} marketRate={wstmgpYmgpCurveRate} supply={supplies.yMGP} symbol="yMGP" underlying={supplies.yMGP} underlyingSymbol="wstMGP" />
