...
export const TokenCards = memo((): ReactElement => {
  ...
  return <div className="grid grid-cols-4 gap-4 mb-4">
    <TokenCard symbol='MGP' price={prices.MGP} decimals={decimals.MGP} supply={supplies.mgp} locked={locked.reefiMGP} description='MGP is the underlying asset all derivatives rely on.' />
