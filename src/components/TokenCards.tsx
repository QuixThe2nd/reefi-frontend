...
export const TokenCards = memo(({ mgpLocked, mgpPrice, mgpSupply, rmgpSupply, ymgpSupply, ymgpLocked, reefiMGPLocked, mgpRmgpCurveRate, rmgpYmgpCurveRate }: Properties): ReactElement => <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
  ...
  <TokenCard color='green' decimals={decimals.rMGP} description='rMGP earns auto compounding yield from locked MGP, while remaining liquid. rMGP can be converted back to MGP.' marketRate={mgpRmgpCurveRate} supply={rmgpSupply} symbol='rMGP' underlying={reefiMGPLocked} underlyingSymbol='MGP' />
