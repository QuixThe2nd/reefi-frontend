...
const Badge = ({ title, value, breakdown }: Readonly<{ title: string; value: string; breakdown?: Yield[] }>): ReactElement => <div className="group relative flex cursor-help items-center rounded-lg bg-gray-700 px-3 py-1 text-sm" title={`${title}: ${value}`}>
...
export const YieldBadge = ({ asset, apy, apr, suffix, breakdown, value }: Properties): ReactElement => {
