...
export const cMGP = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: "xcp_ma_time", type: "uint256", indexed: false }
    ],
    anonymous: false,
    type: "event"
  },
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: "tokens", type: "uint256[3]", indexed: false }
    ],
    anonymous: false,
    type: "event"
  },
  {
    ...
    inputs: [
      ...
      { name: "__packed_precisions", type: "uint256" },
  ...
  { stateMutability: "view", type: "function", name: "xcp_oracle", inputs: [], outputs: [{ name: "", type: "uint256" }] },
  ...
  { stateMutability: "nonpayable", type: "function", name: "stop_ramp_A_gamma", inputs: [], outputs: [] },
  {
    ...
    inputs: [
      ...
      { name: "_new_xcp_ma_time", type: "uint256" }
    ],
    outputs: []
  },
  ...
  { stateMutability: "view", type: "function", name: "last_xcp", inputs: [], outputs: [{ name: "", type: "uint256" }] },
  { stateMutability: "view", type: "function", name: "xcp_ma_time", inputs: [], outputs: [{ name: "", type: "uint256" }] },
