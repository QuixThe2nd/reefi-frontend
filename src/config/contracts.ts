...
const bscContracts: ContractAddresses = {
  ...
  ETH: getContract({ address: '0x0000000000000000000000000000000000000000' as const, abi: ABIs.ETH, client: publicClients[56] }),
  BNB: getContract({ address: '0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c' as const, abi: ABIs.BNB, client: publicClients[56] }),
...
const arbContracts: ContractAddresses = {
  ...
  ETH: getContract({ address: '0x82aF49447D8a07e3bd95BD0d56f35241523fBab1' as const, abi: ABIs.ETH, client: publicClients[42_161] }),
  BNB: getContract({ address: '0x20865e63B111B2649ef829EC220536c82C58ad7B' as const, abi: ABIs.BNB, client: publicClients[42_161] }),
