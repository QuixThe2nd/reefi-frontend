...
export const approve = ({ send, chain }: Properties) => (coin: TransferrableCoin, spender: "wstMGP" | "stMGP" | "yMGP" | "vMGP" | "cMGP" | "odosRouter", infinity: boolean, writeContract: UseWriteContractReturnType<typeof wagmiConfig>["writeContract"]): void => {
