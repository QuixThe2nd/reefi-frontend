...
export const BurnWSTMGP = ({ balances, setSend, send, allowances, chain, approve, mintWETH, curveAmounts, supplies, nativeSwap, odosBuy, curveBuy }: Properties): ReactElement => <Page info={<span>wstMGP can be unwrapped as stMGP. 1 stMGP represents 1 vlMGP but earns no yield. stMGP can be bridged cross-chain.</span>} noTopMargin>
  <SwapToken allowances={allowances} approve={approve} balances={balances} chain={chain} curveAmounts={curveAmounts} curveBuy={curveBuy} excludeCoins={["CKP", "PNP", "EGP", "LTP", "WETH", "MGP", "ETH", "cMGP", "vMGP", "yMGP", "syMGP", "vlMGP", "rMGP", "bMGP"]} label="Unwrap" mintWETH={mintWETH} nativeSwap={nativeSwap} odosBuy={odosBuy} originalTokenIn="wstMGP" send={send} setSend={setSend} supplies={supplies} tokenOut="stMGP" />
</Page>;
