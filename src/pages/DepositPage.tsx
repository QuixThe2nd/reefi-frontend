...
export const DepositPage = memo((): ReactElement => {
  ...
  return <Page info="MGP can be converted to rMGP to earn auto compounded yield. Yield is accrued from vlMGP SubDAO Rewards.">
    <SwapToken originalTokenIn="MGP" tokenOut="rMGP" nativeRate={1/exchangeRates.mintRMGP} curveAmount={amounts.mgpRmgpCurve} buy={actions.buyRMGP} label="Mint" nativeSwap={actions.depositMGP} excludeCoins={['CKP', 'PNP', 'EGP', 'LTP', 'WETH']} />
