...
import type { Chains, CoreCoin, TransferrableCoin } from "../config/contracts";
...
export const GetWRMGPPage = memo(({ balances, setSend, send, allowances, chain, approve, mintWETH, swap, curveAmounts, supplies, nativeSwap }: Properties): ReactElement => <Page info={<span>wstMGP can be unwrapped as stMGP. 1 stMGP represents 1 vlMGP but earns no yield. stMGP can be bridged cross-chain.</span>} noTopMargin>
