...
export const GetYMGP = ({ balances, setSend, send, allowances, approve, mintWETH, curveAmounts, supplies, curveBuy, nativeSwap, odosBuy }: Properties): ReactElement => <Page info={<span>yMGP is backed 1:1 by wstMGP. 1 yMGP can be redeemed for 0.75 wstMGP. yMGP alone has no additional benefit over wstMGP, it must be locked for boosted yield.</span>}>
  <SwapToken allowances={allowances} approve={approve} balances={balances} curveAmounts={curveAmounts} curveBuy={curveBuy} excludeCoins={["CKP", "EGP", "PNP", "LTP", "WETH", "ETH", "cMGP", "stMGP", "vlMGP", "MGP", "vMGP", "syMGP", "rMGP", "bMGP"]} label="Mint" mintWETH={mintWETH} nativeSwap={nativeSwap} odosBuy={odosBuy} originalTokenIn="wstMGP" send={send} setSend={setSend} supplies={supplies} tokenOut="yMGP" />
</Page>;
