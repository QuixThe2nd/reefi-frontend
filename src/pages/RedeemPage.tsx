...
export const RedeemPage = memo((): ReactElement => {
  ...
  return <Page info={[
    ...
    <SwapToken originalTokenIn="rMGP" tokenOut="MGP" nativeRate={0.9*exchangeRates.mintRMGP} curveAmount={amounts.rmgpMgpCurve} buy={actions.buyMGP} nativeSwap={actions.redeemRMGP} label="Redeem via Queue" excludeCoins={['CKP', 'PNP', 'EGP', 'LTP', 'WETH']} />
