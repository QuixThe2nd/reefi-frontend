...
export const RedeemPage = memo((): ReactElement => {
  ...
  return <Page info={[
    ...
    <div className="grid grid-cols-2 gap-2">
      <button type="submit" className="py-2 rounded-lg transition-colors bg-green-600 hover:bg-green-700 h-min" onClick={actions.redeemRMGP}>Redeem via Queue ({(exchangeRates.curve.rmgpMGP*formatEther(amounts.send)).toFixed(4)} MGP)</button>
