...
export const SellYMGP = ({ balances, setSend, send, allowances, chain, approve, mintWETH, curveAmounts, supplies, curveBuy, nativeSwap, odosBuy }: Properties): ReactElement => <Page info={[<span key="redeem_options">yMGP can be redeemed for 75% of it&apos;s underlying wstMGP instantly or swapped at market rate via Curve.</span>, <span key="withdraw_fee">60% of the withdraw fee (15% of withdraw) is distributed to yMGP lockers with 40% of the fee (10% total) sent to the treasury.</span>]}>
  <SwapToken allowances={allowances} approve={approve} balances={balances} chain={chain} curveAmounts={curveAmounts} curveBuy={curveBuy} excludeCoins={["CKP", "PNP", "EGP", "LTP", "WETH", "ETH", "cMGP", "vMGP", "vlMGP", "stMGP", "MGP", "wstMGP", "syMGP", "rMGP", "bMGP"]} label="Redeem" mintWETH={mintWETH} nativeSwap={nativeSwap} odosBuy={odosBuy} originalTokenIn="yMGP" send={send} setSend={setSend} supplies={supplies} tokenOut="stMGP" />
</Page>;
