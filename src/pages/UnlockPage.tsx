...
export const UnlockPage = memo((): ReactElement => {
  ...
  return <>
    <div className="bg-gray-700/50 p-5 rounded-lg">
      <AmountInput label="Unlock yMGP" balance={balances.YMGP[0]} value={amounts.send} onChange={amounts.setSend} token={{ symbol: 'yMGP', color: 'bg-green-400', bgColor: 'bg-green-600' }} />
