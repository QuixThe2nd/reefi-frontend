...
export const UnwrapWRMGPPage = memo(({ balances, setSend, send, allowances, chain, approve, mintWETH, swap, curveAmounts, supplies, nativeSwap }: Properties): ReactElement => <Page info={<span>stMGP can be wrapped for wstMGP. 1 stMGP receives 1 vlMGP worth of wstMGP. stMGP can be wrapped on any chain.</span>} noTopMargin>
