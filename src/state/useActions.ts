...
export const useActions = ({ wallet, updateWallet, updateBalances, updateSupplies, amounts, allowances, updateAllowances, contracts, setError, setNotification }: Props) => ({
  ...
  supplyLiquidity: useSupplyLiquidity({ account: wallet.account, chain: wallet.chain, clients: wallet.clients, mgpLPAmount: amounts.lp.MGP, rmgpLPAmount: amounts.lp.rMGP, setConnectRequired: updateWallet.setConnectRequired, updateBalances, writeContracts: contracts, ymgpLPAmount: amounts.lp.yMGP }),
